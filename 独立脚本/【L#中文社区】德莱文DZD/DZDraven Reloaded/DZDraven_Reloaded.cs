...
namespace DZDraven_Reloaded
{
    class DZDraven_Reloaded
    {
        ...
        public static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Menu = new Menu("【L#中文社区】德莱文", "DravenReloaded", true);
            ...
            Menu.SubMenu("Combo").AddItem(new MenuItem("CAC", "使用连招接斧头").SetValue(true));
            ...
            Menu.SubMenu("Harrass").AddItem(new MenuItem("CAH", "使用骚扰接斧头").SetValue(true));
            ...
            Menu.SubMenu("Farm").AddItem(new MenuItem("CAF", "使用清线接斧头").SetValue(true));

            Menu.AddSubMenu(new Menu("斧头设置", "Axes"));
            ...
            Menu.SubMenu("Axes")
                .AddItem(new MenuItem("CatchRadius", "斧头捕获半径").SetValue(new Slider(600, 200, 1000)));
            Menu.SubMenu("Axes")
                .AddItem(new MenuItem("SafeZone", "斧头安全区域").SetValue(new Slider(125, 0, 325)));
            ...
            Menu.SubMenu("Drawing").AddItem(new MenuItem("DrawCRange", "接斧头范围").SetValue(new Circle(true, Color.RoyalBlue)));
            Menu.SubMenu("Drawing").AddItem(new MenuItem("DrawRet", "阻挡斧头落点").SetValue(new Circle(true, Color.Yellow)));
            Menu.SubMenu("Drawing").AddItem(new MenuItem("DrawNextRet", "正常斧头落点").SetValue(new Circle(true, Color.Orange)));
            Menu.AddToMainMenu();
