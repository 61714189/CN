...
namespace FioraRaven
{
    class Fiora
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            menu = new Menu("【L#中文社区】剑姬","Fiora",true);
        ...
        {        
            ...
            if(target.IsValidTarget(Q.Range) && Q.IsReady()&&Q.InRange(target.ServerPosition) && !firstQ && isEn("UseQ") && (Game.TimeQCastTime)>=(menu.Item("SecondQDelay").GetValue<Slider>().Value/1000))
            {
