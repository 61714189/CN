...
namespace Primes_Ultimate_Carry
{
	class PUC
	{
		...
		public PUC()
		{
			...
			Game.PrintChat("<font color=\"#00BFFF\">====== 鎴愬姛杞藉叆:銆怢#涓枃绀惧尯銆戙劎Primes澶氳嫳闆勫悎闆嗐劎 ======</font>");
			...
			Game.PrintChat("<font color=\"#00BFFF\">鏇村姹夊寲鑴氭湰 www.loll35.com</font>");

			Player = ObjectManager.Player;
			Menu = new Menu("【L#中文社区】多英雄合集", Player.ChampionName + "UltimateCarry", true);
